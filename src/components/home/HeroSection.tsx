...
/>
        ...
        >
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl px-4 sm:px-6 lg:px-8 pt-4 sm:pt-6">
              ...
              <p className="mt-4 sm:mt-6 text-sm sm:text-base md:text-lg text-white/90 leading-relaxed max-w-3xl">
                A dynamic one-stop knowledge hub dedicated <br />
                to amplifying the voices, achievements, and insights <br />
